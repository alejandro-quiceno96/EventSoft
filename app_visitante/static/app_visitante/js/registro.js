document.addEventListener('DOMContentLoaded', function () {
    ...
    const validarPassword = () => {
        ...
        const tieneLetra = /[a-zA-Z]/.test(p1); // Django requiere que no sea solo numérica
        ...
        // Uppercase y special son sugerencias de fuerza (no bloquean)
        ...
        // El botón se habilita cuando se cumplen las MISMAS reglas que Django:
        // - mínimo 8 caracteres
        // - no es solo numérica (tieneLetra)
