...
class AsistentesEventos(models.Model):
    ...
    asi_eve_soporte = models.URLField(blank=True, null=True)
    asi_eve_qr = models.URLField(blank=True, null=True)
...
class ParticipantesEventos(models.Model):
    ...
    par_eve_documentos = models.URLField(blank=True, null=True)
    par_eve_estado = models.CharField(max_length=45)
    par_eve_qr = models.URLField(blank=True, null=True)
...
class EvaluadoresEventos(models.Model):
    ...
    eva_eve_documentos = models.URLField(blank=True, null=True)
    eva_estado = models.CharField(max_length=45, null=True, blank=True)
    eva_eve_qr = models.URLField(blank=True, null=True)
...
class Proyecto(models.Model):
    ...
    pro_documentos = models.URLField(blank=True, null=True)
