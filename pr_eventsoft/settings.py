...
AUTH_PASSWORD_VALIDATORS = [
    {
        # Mínimo 8 caracteres — corresponde a la regla visual "Al menos 8 caracteres"
        'NAME': 'django.contrib.auth.password_validation.MinimumLengthValidator',
        'OPTIONS': {'min_length': 8}
    },
    {
        # No solo numérica — corresponde a la regla visual "Un número" (debe tener al menos una letra)
...
# Configuración de correo utilizando decouple para mayor robustez
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = config('EMAIL_HOST', default='smtp-relay.brevo.com')
# Lógica dinámica: Si el puerto es 465 usar SSL, si es 587 usar TLS
...
LOGGING = {
    ...
    'loggers': {
        'django': {
            'handlers': ['console'],
            'level': 'INFO',  # Cambiado de ERROR a INFO para ver más detalles
            'propagate': False,
        },
    },
}
